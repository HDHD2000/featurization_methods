...
#Constructing the sample points and their persistence diagrams using 
...
for _ in range(repetitions):
    ...
    for _ in range(num_diag_per_class):
        ...
        dgms.append(AlphaTorus.persistence_intervals_in_dimension(1)) ##contains all persistence diagrams of dimension 1 of the sphere and torus
        
    train_labs, test_labs, train_dgms, test_dgms = train_test_split(labs, dgms)  #dividing the diagrams into a training and a testing set
